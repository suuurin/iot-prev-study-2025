...
#### 파이썬이란?
- 귀도 반 로썸 1990 개발한 초간단 인터프리터 프로그래밍 언어
...
- https://www.tiobe.com/tiobe-index/ 2020년 이후 1위
- 빅데이터 분석, 인공지능, 웹개발(!) 등 다양한 분야 활용

##### 파이썬 설치
- Install Now로 설치하면 안 됨! Costomize installation으로 설치
- Add Python.exe to Path 는 체크
- 경로 변경
- 설치 후 Disable MAX Langs PATH... 체크 필수
- 설치 확인
    -cmd(명령 프롬포트) 또는 powershell 실행 후 python 입력
